        ...
        <div class="panel panel-default content-main">
            <form name="question" method="post" action="/qna/update">
                <div class="form-group">
                    ...
                    <input class="form-control" type="hidden" name="writer" value="${question.writer}"/>
                    <input class="form-control" disabled id="writer" name="writer" placeholder="글쓴이" value="${question.writer}"/>
                </div>
                <div class="form-group">
